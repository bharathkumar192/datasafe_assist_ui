...
const Container: React.FC = () => {
  ...
  return (
    <div className="main">
      <div className="nav">
        <a href="#" target="new"><p>DataSafe</p> </a>
          ...
          <>
            {!isFileUploaded ? (
              <div className="greet">
                ...
                <p>Want to add more files?</p>
              </div>
            ) : (
              <div className="greet">Any Questions regarding DataSafe ?</div>
            )}
     ...
     { isFileUploaded &&  <div className="main-bottom">
          ...
          <div className="bottom-info">
            <p>DataSafe Assistant answers based on datasafe documentation.</p>
          </div>
        </div>}
      </div>
    </div>
